...
var Footer = (function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    key: 'render',
    value: function render() {
      var leaderboardCharacters = Array.isArray(this.state.characters) ? this.state.characters.map(function (character) {
        return _react2['default'].createElement(
          'li',
...
var Home = (function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      var characterNodes = Array.isArray(this.state.characters) ? this.state.characters.map(function (character, index) {
        return _react2['default'].createElement(
          'div',
